  ...
  return (
    <section className="mx-auto flex w-full items-center justify-center pt-0">
      <div className="hidden items-center justify-center gap-1 sm:grid md:grid-cols-2">
        <div className="relative col-span-1 rounded-xl bg-black/15 md:rounded-none md:rounded-l-xl  ">
          <img
            ...
            >
              ...
              {index === 3 && (
                <>
                  <AllPhotos
                    photos={images}
                    className="absolute bottom-5 right-5 hidden items-center space-x-3 rounded-md bg-white px-3 py-2 text-xs font-semibold ring-1 ring-black md:flex xl:text-sm"
                  >
                    <Grip size={18} />
                    <span>Show all photos</span>
                  </AllPhotos>
