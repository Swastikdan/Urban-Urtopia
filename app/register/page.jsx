...
//         } else if (
//           nameParts.some((part) => part.length < 3 || !validator.isAlpha(part))
//         ) {
...
// //     e.preventDefault();
// //     setLoading(true);
// //     // Validation check before making the request
// //     for (const field in data) {
// //       validateField(field, data[field].trim());
// //     }

// //     // Check if any errors exist in validationErrors state
// //     const hasErrors = Object.values(validationErrors).some(
// //       (error) => error !== '',
// //     );
