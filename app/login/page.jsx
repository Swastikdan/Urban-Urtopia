...
export default function page() {
  ...
  return (
    <main className=" mx-auto mt-5 w-full max-w-md sm:mt-0 md:p-6">
            ...
            <form onSubmit={handleSubmit}>
              <div className="grid gap-y-4">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="inline-flex w-full items-center justify-center gap-x-2 rounded-lg border border-transparent bg-primary px-4 py-3 text-base font-semibold   hover:bg-primary/90 disabled:pointer-events-none disabled:opacity-70 text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600"
                >
                  <Loader2
                    width={24}
                    height={24}
